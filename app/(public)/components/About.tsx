...
export function About({ media }: { media: MediaMap }) {
  return (
      ...
      <div className="section-shell grid items-center gap-12 md:grid-cols-[0.9fr_1.1fr]">
        ...
        <div>
          ...
          <h2 className="mt-4 text-3xl font-extrabold leading-[1.08] text-ves-paper md:text-5xl">
            Practical infrastructure technology for local governments and rural communities
          </h2>
          <p className="mt-6 text-base leading-8 text-ves-paper/75 md:text-lg">
            VES was founded to solve a municipal problem observed directly in the field: streetlights running around the clock, wasting electricity, burning out hardware, and creating recurring repair costs for local bodies.
          </p>
